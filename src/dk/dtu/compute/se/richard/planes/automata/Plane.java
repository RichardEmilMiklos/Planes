...
public class Plane extends AbstractPetrinetBehaviour<planes.Plane> {
	
	public Plane(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (planes.Plane) element, new int[]{1}, new String[]{"t1"}, type );
	}
